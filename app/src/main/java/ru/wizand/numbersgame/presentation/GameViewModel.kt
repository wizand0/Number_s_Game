...
import ru.wizand.numbersgame.data.GameRepositoryImpl
...
import ru.wizand.numbersgame.domain.usecases.GenerateQuestionUseCase
import ru.wizand.numbersgame.domain.usecases.GetGameSettingsUseCase
...
//    private lateinit var level: Leve
//l
...
//    }
    ...
    private fun startTimer() {
        timer = object : CountDownTimer(
            gameSettings.gameTimeInSeconds * MILLI_IN_SECONDS,
            MILLI_IN_SECONDS
        ) {
    ...
    private fun generateQuestion() {
        _question.value = generateQUestionUseCase(gameSettings.maSumValue)
    }

    private fun formatTime(millisUntilFinished: Long): String {
        val seconds = millisUntilFinished / MILLI_IN_SECONDS
    ...
    companion object {
        ...
        private const val MILLI_IN_SECONDS = 1000L
